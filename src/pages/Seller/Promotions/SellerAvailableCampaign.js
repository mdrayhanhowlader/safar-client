...
const SellerAvailableCampaign = () => {
  return (
    <div className="flex flex-col md:flex-row flex-wrap-reverse justify-center md:justify-between">
      <div class="flex">
        <div class="flex flex-col md:flex-row md:max-w-3xl md:h-36 my-2 rounded-lg bg-white shadow-lg">
          <img
          ...
          <div class="px-6 flex flex-col justify-start">
            <h5 class="text-rose-900 text-xl font-medium mb-2">
              Valentine Campaign
            </h5>
            <p class="text-rose-700 text-base mb-2">
              15% off for all visitors.
            </p>
            <p class="text-rose-600 text-xs mb-2">Feb 14th - Feb 15th</p>
