        ...
        <div style={{ backgroundImage: `url(${guide})` }} className="bg-cover">
            ...
            <Navbar/>
                ...
                <div className='flex  items-center mt-24 ml-16 pb-24'>
                    <h1 className="text-5xl text-indigo-900 font-semibold">Find Your Guide
            ...
            <div>
                <div className='grid gap-6 grid-cols-1 lg:grid-cols-3 p-6'>
                    {
                        guides?.map(guide =>
                            <div className="w-full border-2 shadow-lg shadow-blue-300 border-gray-400 bg-slate-50 rounded-lg p-4 sm:flex sm:space-x-6 ">
                                <div className="flex-shrink-0 w-full mb-6 h-56 sm:h-44 sm:w-44 sm:mb-0">
                                    <img src={guide?.photo} alt="" className="object-cover object-center w-full h-full rounded-md dark:bg-gray-500" />
                                </div>
                                <div className="flex flex-col space-y-4">
                                    ...
                                    <div className="">
                                        ...
                                        <span className="flex items-center space-x-2">
                                            ...
                                            <span className="dark:text-gray-400">{guide?.location}</span>
                                        </span>
